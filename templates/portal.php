...
<div class="wrapper-floor-gizmos">
    ...
    ?>
    <div id="portal-<?php echo esc_attr($portal_id); ?>" 
         class="<?php echo esc_attr(implode(' ', $portal_classes)); ?>"
         data-portal-id="<?php echo esc_attr($portal_id); ?>"
         data-portal-type="<?php echo esc_attr($portal_type); ?>"
         data-tooltip="<?php echo esc_attr($portal_title); ?>"
